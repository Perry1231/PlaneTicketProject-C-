...
//Розділити створення літакі на 3 функції
/*
Зробити три окремі фунції дн одна буде за літак де ширина сидінь 1 . Друга буде за літак де ширина сидінь 2. Третя буде за літак де ширина сидінь 3. В кожній функції буде випадковим чином генеруватися довжина літака від 1 до 25. Виводити на екран зображення літака відповідно до його довжини та ширини сидінь. Використовувати символи для зображення літака, наприклад, "-" для корпусу та "|" для сидінь.
*/